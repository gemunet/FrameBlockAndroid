...
public abstract class SimpleSliderActivity extends AppCompatActivity {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == mStepLayouts.length - 1) {
                    ...
                    btnNext.setText(getString(R.string.fb_simpleslider_complete));
                    btnSkip.setVisibility(View.GONE);
                } else {
                    // still pages are left
                    btnNext.setText(getString(R.string.fb_simpleslider_next));
    ...
    private void addBottomDots(int currentPage) {
        ...
        int colorActive = getResources().getColor(R.color.fb_simpleslider_dot_active);
        int colorInactive = getResources().getColor(R.color.fb_simpleslider_dot_inactive);
