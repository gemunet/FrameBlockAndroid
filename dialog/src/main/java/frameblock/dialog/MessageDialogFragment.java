...
public class MessageDialogFragment extends DialogFragment {
    ...
    public static class Builder {
        ...
        private int titleId;
        private int iconId;
        private int positiveTextId = R.string.fb_dialog_message_button_positive;
    ...
    public static class Alert extends Builder {
        public Alert(String message) {
            setPositiveTextId(R.string.fb_dialog_message_button_positive);
            setMessage(message);
        }
    }
    ...
    public static class Success extends Builder {
        public Success(String message) {
            setMessage(message);
            setIconId(R.drawable.ic_dialog_check_black_24dp);
        }
    }
    ...
    public static class Info extends Builder {
        public Info(String message) {
            setPositiveTextId(R.string.fb_dialog_message_button_positive);
            setMessage(message);
            setIconId(R.drawable.ic_dialog_info_outline_black_24dp);
        }
    }
    ...
    public static class Warning extends Builder {
        public Warning(String message) {
            setPositiveTextId(R.string.fb_dialog_message_button_positive);
            setMessage(message);
            setIconId(R.drawable.ic_dialog_warning_black_24dp);
        }
    }
    ...
    public static class Error extends Builder {
        public Error(String message) {
            setPositiveTextId(R.string.fb_dialog_message_button_positive);
            setMessage(message);
            setIconId(R.drawable.ic_dialog_error_outline_black_24dp);
            setTitleId(R.string.fb_dialog_error_title);
        }
    }

    public static class ErrorRetry extends Builder {
        public ErrorRetry(String message) {
            setPositiveTextId(R.string.fb_dialog_retry_button_positive);
            setNegativeTextId(R.string.fb_dialog_retry_button_negative);
            setMessage(message);
            setIconId(R.drawable.ic_dialog_error_outline_black_24dp);
            setTitleId(R.string.fb_dialog_error_title);
        }
    ...
    public static class Confirm extends Builder {
        public Confirm(String message) {
            setPositiveTextId(R.string.fb_dialog_confirm_button_positive);
            setNegativeTextId(R.string.fb_dialog_confirm_button_negative);
            setMessage(message);
            setIconId(R.drawable.ic_dialog_check_black_24dp);
        }
    }
