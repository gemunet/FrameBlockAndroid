...
import frameblock.dialog.LoadingDialogFragment;
import frameblock.dialog.MessageDialogFragment;
                ...
                new MessageDialogFragment.Confirm("Hi world!")
                        .setPositiveListener(new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(DialogActivity.this, "Positive", Toast.LENGTH_LONG).show();
                            }
                        })
            ...
            public void onClick(View view) {
                new MessageDialogFragment.ErrorRetry("Hi world!")
                        .setPositiveListener(new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(DialogActivity.this, "Retry", Toast.LENGTH_LONG).show();
                            }
                        })
                        .setNegativeListener(new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(DialogActivity.this, "Cancel", Toast.LENGTH_LONG).show();
                            }
                        })
                        .show(getSupportFragmentManager());
